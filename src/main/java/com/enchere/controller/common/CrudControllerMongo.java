...
import com.enchere.model.HasIdMongo;
...
public class CrudControllerMongo<E extends HasIdMongo, S extends Service<E>> {

    protected final S service;

    public CrudControllerMongo(S service) {
    ...
    @GetMapping("/{id}")
    public ResponseEntity<SuccessResponse> findById(@PathVariable("id") String id) {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<SuccessResponse> update(@PathVariable("id") String id, @RequestBody E obj) throws CustomException {
        obj.setId(id);
